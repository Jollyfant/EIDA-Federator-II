...
Thread.prototype.HTTPRequest = function() {
  ...
  // Define the request 
  this._request = http.get(this.createRequestOptions(), function(response) {
...
Thread.prototype.createRequestOptions = function() {

  /* FUNCTION Thread.createRequestOptions
   * Creates an object with HTTP request options
   */
